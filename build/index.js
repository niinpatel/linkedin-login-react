...
var LinkedIn = function (_Component) {
  ...
  function LinkedIn() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = LinkedIn.__proto__ || Object.getPrototypeOf(LinkedIn)).call.apply(_ref, [this].concat(args))), _this), _this.restart = function () {
      var urlParams = new URLSearchParams(window.location.search);
      var redirectUri = localStorage.linkedInReactRedirectUri;
      var previousState = localStorage.linkedInReactState;
      ...
      if (error) {
        _this.props.callback(error, null, null);
      } else if (redirectUri && code && previousState === newState) {
        _this.props.callback(null, code, redirectUri);
      }
      ...
      window.location.href = (0, _getURL2.default)(clientId, state, scope); // build url out of clientid, scope and state
...
exports.default = function (clientId, state, scope) {
